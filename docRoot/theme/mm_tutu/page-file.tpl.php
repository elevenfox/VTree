...
<?php $file = $data['file'];?>
  ...
  <div id="content_file_hz">
    <div class="picture_1000">
      <img id="picture_1000_img" src="<?php print $file['thumbnail'];?>"></img>
      <div id="picture_prev">
    ...
    <div class="list_others_container" id="<?php print $file['fd_id']; ?>">
     ...
     <div id="load_prev" class="fleft"  <?php if(!$data['sameFilesPrevMore']) {?>style="display:none"<?php }?> >
       <a href="#"></a>
     </div>
     <div id="list_others" class="fleft">
      ...
      ?>
        <li class="picture_120">
          <a href="/photo/<?php print $sameFile['fid'];?>">
            <img <?php print $current_class;?> 
               id="<?php print $sameFile['fid'];?>" 
               src="<?php print $sameFile['thumbnail'];?>">
            </img>
          </a>
        </li>
      <?php }?>
     ...
     <div id="load_next" class="fleft" <?php if(!$data['sameFilesNextMore']) {?>style="display:none"<?php }?> >
       <a href="#"></a>
     </div>
